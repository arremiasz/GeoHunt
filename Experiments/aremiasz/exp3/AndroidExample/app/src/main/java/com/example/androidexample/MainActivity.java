...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botNav = findViewById(R.id.bottom_navigation);      // link to bottom navigation bar in the Main activity XML
        ...
        if(extras == null) {
            ...
            HomeFragment home = new HomeFragment(extras.getString("USERNAME"));
