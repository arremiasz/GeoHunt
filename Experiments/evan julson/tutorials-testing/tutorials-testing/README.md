...
These examples use JUnit 4. Springboot versions 2.2.0 and later default to JUnit 5 when using "spring-boot-starter-test". 
To force your project to use JUnit 4, this dependency is added to the pom.xml file:
